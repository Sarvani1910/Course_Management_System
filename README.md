To run the application, you need to install the necessary dependencies for both the frontend and backend. First, navigate to the frontend directory using the command cd frontend. 
